...
class ChartManager {
                        ...
                        callbacks: {
                            ...
                            afterBody: (context) => {
                                ...
                                const event = this.events.find(e => 
                                    Math.abs(e.timestamp - timestamp) < 300000 // 5 minutos
                                );
    ...
    updateDatasets() {
        ...
        if (this.showTrendLine && this.data.length > 1) {
            ...
            datasets.push({
                ...
                borderColor: appConfig.chart.trendLineColor,
                borderWidth: appConfig.chart.trendLineWidth,
                borderDash: [5, 5],
                pointRadius: 0,
                pointHoverRadius: 0,
                fill: false,
    ...
    calculateTrendLine() {
        ...
        // Usar índices para cálculo de tendência
    ...
    formatAxisDate(date) {
        try {
            ...
            if (diffHours < 24) {
                // Últimas 24h: mostrar hora
                return date.toLocaleTimeString('pt-BR', { 
                    hour: '2-digit', 
                    minute: '2-digit' 
                });
            } else if (diffHours < 168) {
                // Última semana: mostrar dia/mês
                return date.toLocaleDateString('pt-BR', { 
                    day: '2-digit', 
                    month: '2-digit' 
                });
            } else {
                // Mais antigo: mostrar mês/ano
                return date.toLocaleDateString('pt-BR', { 
                    month: '2-digit', 
                    year: '2-digit' 
                });
